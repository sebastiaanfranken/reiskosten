<div class="container">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="active"><a href="<?php print action('DashboardController@getCreateUser');?>">Gebruiker toevoegen</a></li>
	...
	<div class="tab-content">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<?php print Form::password('password', array('class' => 'form-control', 'required' => 'required', 'placeholder' => 'Het wachtwoord'));?>
			</div> <!-- /.col-sm-10 -->
		</div> <!-- /.form-group -->
		<div class="form-group">
			<?php print Form::label('password_check', 'Controle wachtwoord', array('class' => 'col-sm-2 control-label'));?>
			<div class="col-sm-10">
				<?php print Form::password('password_check', array('class' => 'form-control', 'required' => 'required', 'placeholder' => 'Het wachtwoord, nogmaals'));?>
			</div> <!-- /.col-sm-10 -->
		</div> <!-- /.form-group -->
		<div class="form-group">
